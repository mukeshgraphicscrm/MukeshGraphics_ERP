  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (quotationToEdit) {
        ...
        if (isAdmin && formData.employee && formData.employee !== quotationToEdit.employee && formData.employee !== userName) {
          try {
      ...
      <div className="bg-white rounded-xl shadow-lg w-full max-w-2xl flex flex-col max-h-[calc(100dvh-4rem)] md:max-h-[90vh] overflow-hidden">
        ...
        {fetching ? (
          ...
          <form onSubmit={handleSubmit} noValidate className="p-6 overflow-y-auto flex-1 scrollbar-thin scrollbar-thumb-gray-300">
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 space-y-0">
                        <div className="md:col-span-2">
                          ...
                          <textarea
                            ...
                            disabled={isViewMode}
                            className={`w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-brand-accent/50 focus:border-brand-accent transition-colors resize-y ${isViewMode ? 'bg-gray-50 border-gray-300 text-gray-500 cursor-not-allowed' : 'border-gray-300'}`}
            ...
            <div className={`mt-8 flex flex-col-reverse sm:flex-row ${quotationToEdit ? 'sm:justify-between' : 'sm:justify-end'} items-stretch sm:items-center gap-3 border-t border-gray-100 pt-5`}>
              {quotationToEdit && (
                <button
                  type="button"
      ...
      {showWhatsappPrompt && (
        <div className="fixed inset-0 z-[60] flex items-center justify-center p-4 bg-black/50 backdrop-blur-sm">
          <div className="bg-white rounded-xl shadow-lg w-full max-w-sm p-6 text-center">
            ...
            <p className="text-sm text-gray-500 mb-6">Would you like to send this quotation to the client on WhatsApp?</p>
