  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-2 gap-6">
        ...
        {/* LEFT: Design Status */}
        <div className="bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden" style={{ height: '290px' }}>
          {/* Header */}
          ...
          {/* Scrollable table — exactly fills remaining height */}
          <div style={{ height: 'calc(290px - 49px)', overflowY: 'auto', overflowX: 'hidden' }}>
        ...
        <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-5" style={{ height: '290px' }}>
          <h3 className="text-[14px] font-semibold text-gray-800 mb-4">Job Preparation Summary</h3>
          <div className="grid grid-cols-2 gap-3" style={{ height: 'calc(290px - 80px)' }}>
            {[
              ...
              >
                <div className={cn('p-2 rounded-full mb-1.5 group-hover:scale-110 transition-transform', iconCls)}>
                  <Icon className="w-5 h-5" strokeWidth={2} />
                </div>
                <span className="text-[22px] font-bold text-gray-800 leading-none">{count}</span>
                <span className="text-[10px] font-semibold text-gray-500 uppercase tracking-widest mt-1">{key}</span>
              </button>
            ))}
          </div>
        </div>
          ...
          actionButton={
            <div className="flex items-center gap-2">
              ...
              >
                ...
                <span className="font-bold uppercase tracking-wide">New Job</span>
              </button>
            </div>
          }
        />
